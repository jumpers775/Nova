...
fn main() -> glib::ExitCode {
    ...
    // Load resources
    let resources = gio::Resource::load(PKGDATADIR.to_owned() + "/nova.gresource")
    ...
    app.connect_startup(|_| {
        ...
        provider.load_from_resource("/com/lucamignatti/nova/gtk/style.css");
